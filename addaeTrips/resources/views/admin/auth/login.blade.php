    ...
    <div class="page page-center">
      <div class="container container-tight py-4">
            ...
            <form method="POST" action="{{ route('admin.login') }}">
              ...
              <div class="mb-2">
                ...
                <div class="input-group input-group-flat">
                  <input id="password" class="form-control"  placeholder="Your password"  autocomplete="off" type="password"
                            name="password"
                            required autocomplete="current-password" >
                  <span class="input-group-text">
                    <button type="button" id="togglePassword" class="link-secondary btn-link" title="Show password" data-bs-toggle="tooltip"><!-- Download SVG icon from http://tabler-icons.io/i/eye -->
        ...
        <div class="text-center text-secondary mt-3">
          {{ ('Do not have account? ') }}<a href="/login" tabindex="-1">{{ __('Go home') }}</a>
        </div>
      </div>
    </div>
    <!-- Libs JS -->
